...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Joseph', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-jade-tau-63.vercel.app/', // 网站地址
  ...
  PRISM_THEME_LIGHT_PATH:
    ...
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-shades-of-purple.css', // 浅色模式主题
